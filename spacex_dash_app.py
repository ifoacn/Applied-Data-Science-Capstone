...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Total Success Launch for Sites')
        return fig
    else:
...
def scatter_chart(entered_site,payload):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df = spacex_df[spacex_df['Launch Site']== entered_site]
        fig = px.pie(filtered_df,x='Payload Mass (kg)', y='class',title='Success by Payload for site {}'.format(entered_site),color="Booster Version Category")
        return fig
